...
class Battery():
    def __init__(self,battery_size = 710):
...
car = Car('Honda','V2',1981)
car.fill_gas_tank()

my_tesla_car = ElectricCar('tesla','model z', 2024)
print(my_tesla_car.get_descriptive_name())

my_tesla_car.battery_size.describe_battery()
my_tesla_car.fill_gas_tank()
my_tesla_car.battery_size.get_range()